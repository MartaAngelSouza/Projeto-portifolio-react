        ...
        return(
            <nav className="navbar">
                ...
                <div className="navbar-links">
                    <a className="navbar-link">Visão Geral</a>
                    <a className="navbar-link">Repositorios</a>
    ...
    render(){
        return(
            <div className="perfil">
                <Foto 
                    link="https://github.com/MartaAngelSouza" 
                    url="https://avatars.githubusercontent.com/u/74936922?v=4"
                />
        ...
        return (
            <div className="footer">
                ...
                <div className="footer-criado">
                    <p>Criado por <span>{this.props.nome}</span></p>
                </div>
            </div>
        );
    }
        ...
        return (
            ...
            <Icone tamanho={this.props.tamanho} icone={this.props.icone} />
                <div className="habilidade-barraProgresso">
                    <span style={{ width: `${this.props.porcentagem}%`}}>
                    </span>
                </div>
